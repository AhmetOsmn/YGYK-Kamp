    ...
    public class InMemoryCarDal : ICarRentalDal<Car>
    {
        ...
        public InMemoryCarDal()
        {
            _cars = new List<Car> {
                ...
                new Car { Id = 4, BrandId = 2, ColorId = 2, DailyPrice = 150, ModelYear = "2020", Description = " Arac 4" },
                new Car { Id = 5, BrandId = 3, ColorId = 1, DailyPrice = 200, ModelYear = "2015", Description = " Arac 5" },
                new Car { Id = 6, BrandId = 3, ColorId = 2, DailyPrice = 200, ModelYear = "2020", Description = " Arac 6" }
            };
