...
namespace LinqProject
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Algoritmik************************");
            Console.WriteLine(GetProducts(products)[0].ProductName);
            Console.WriteLine("Linq************************");
            Console.WriteLine(GetProductsLinq(products)[0].ProductName); 
        }

        //Filtrelemeye uyan urunleri donduren metotun algoritmik yazilisi.
        ...
        //Yukaridaki metot ile ayni gorevi yapan linq kullanilmis metot
